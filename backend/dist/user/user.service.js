...
let UserService = class UserService {
    ...
    async verifySignUpToken(token) {
        try {
            const decoded = jwt.verify(token, "dcdff54dfec9d03e9784fd27d09f8075e3268b67b2cb12273ee62305bef84b749bcb3a55c1acce91d3d0bb76f2cea901bfb473e6ce2b33e72249fcd70852cddf");
    ...
    async verifyResetPassToken(data) {
        try {
            const decoded = jwt.verify(data.tok, "dcdff54dfec9d03e9784fd27d09f8075e3268b67b2cb12273ee62305bef84b749bcb3a55c1acce91d3d0bb76f2cea901bfb473e6ce2b33e72249fcd70852cddf");
            console.log(decoded.email);
            const user = await this.userRepository.findOne({ where: { email: decoded.email } });
            if (!user)
                throw new Error('User not found');
