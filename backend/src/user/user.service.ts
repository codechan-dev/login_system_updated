...
export class UserService {
  ...
  async register(name: string, email: string, password:string)
  {
    ...
    if(!existingUser){
      ...
      token = await jwt.sign({ email },"dcdff54dfec9d03e9784fd27d09f8075e3268b67b2cb12273ee62305bef84b749bcb3a55c1acce91d3d0bb76f2cea901bfb473e6ce2b33e72249fcd70852cddf", { expiresIn: '3600s' });
      ...
      if(existingUser.isVerified===false){
        const salt = await bcrypt.genSalt(10);
        password = await bcrypt.hash(password, salt);
        token = await jwt.sign({ email }, "dcdff54dfec9d03e9784fd27d09f8075e3268b67b2cb12273ee62305bef84b749bcb3a55c1acce91d3d0bb76f2cea901bfb473e6ce2b33e72249fcd70852cddf", { expiresIn: '1h' });
      ...
      async function tokenGenAndMailsend(){
        ...
        const transporter = await nodemailer.createTransport({
          ...
          secure: false,
          auth: {
            user: 'cse06@ucep.edu.in',
            pass: 'dges okwa ziid xevb',
          },
        });
    
        const mailOptions = {
          from: 'cse06@ucep.edu.in',
          to: email,
  ...
  async verifySignUpToken(token: string){
    try {
      const decoded = jwt.verify(token, "dcdff54dfec9d03e9784fd27d09f8075e3268b67b2cb12273ee62305bef84b749bcb3a55c1acce91d3d0bb76f2cea901bfb473e6ce2b33e72249fcd70852cddf") as { email: string };
  ...
  async verifyResetPassToken(data:any){
    try {
      const decoded = jwt.verify(data.tok, "dcdff54dfec9d03e9784fd27d09f8075e3268b67b2cb12273ee62305bef84b749bcb3a55c1acce91d3d0bb76f2cea901bfb473e6ce2b33e72249fcd70852cddf") as { email: string };
      console.log(decoded.email)
  ...
  async loginUser(data:CreateLoginDto){
    ...
    {
      const token = await jwt.sign({ email }, "dcdff54dfec9d03e9784fd27d09f8075e3268b67b2cb12273ee62305bef84b749bcb3a55c1acce91d3d0bb76f2cea901bfb473e6ce2b33e72249fcd70852cddf", { expiresIn: '1h' });
